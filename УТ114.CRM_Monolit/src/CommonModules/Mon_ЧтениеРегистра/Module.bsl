...
Процедура ЗагрузитьЗаказыИРеализацииПоСпискуДокументовИзСоответствияДанныхXML(СтруктураШлюза, СоответствиеДанныхXML)
	...
	ТЗДокументов.Колонки.Добавить( "ActionDate", 	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 55 ) );
	ТЗДокументов.Колонки.Добавить( "AddressId", 	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) ); 
	ТЗДокументов.Колонки.Добавить( "CRMClientId", 	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) ); 
	ТЗДокументов.Колонки.Добавить( "CompanyId",		Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) );
	...
	ТЗДокументов.Колонки.Добавить( "CRMOrderDate", 	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 55 ) );
	...
	ТЗДокументов.Колонки.Добавить( "PersonId", 		Mon_Общий.УстановитьТипДанных( Тип("Число") ) );
	ТЗДокументов.Колонки.Добавить( "StatusId",		Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) );
	ТЗДокументов.Колонки.Добавить( "Summa", 		Mon_Общий.УстановитьТипДанных( Тип("Строка"), 55 ) );
	...
	ТЗДопСведенийВДокументе.Колонки.Добавить( "CRMOrderDate",	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) );
	...
	ТЗДопСведений.Колонки.Добавить( "CRMOrderDate",		Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) );
	ТЗДопСведений.Колонки.Добавить( "CRMOrderNumber",		Mon_Общий.УстановитьТипДанных( Тип("Строка"), 100 ) );	
	ТЗДопСведений.Колонки.Добавить( "LineNumber",		 	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 100 ) );
	ТЗДопСведений.Колонки.Добавить( "OptionTypeId",	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) );
	ТЗДопСведений.Колонки.Добавить( "Value",	Mon_Общий.УстановитьТипДанных( Тип("Строка"), 30 ) );
