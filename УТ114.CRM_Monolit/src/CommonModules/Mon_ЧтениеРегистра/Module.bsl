...
Процедура ЗагрузитьПоступленияПоСпискуДокументовИзСоответствияДанныхXML(СтруктураШлюза, СоответствиеДанныхXML)
	...
	ТЗДокументов 		= Mon_Общий.ВернутьТЗДокументов();
	ТЗСтрокиДокументов 	= Mon_Общий.ВернутьТЗСтрокиДокументов();
	ТЗСтрокиПартий 		= Mon_Общий.ВернутьТЗСтрокиПартий();
	ТЗПалет 			= Mon_Общий.ВернутьТЗПалет();
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_ТЗСтрокиДокументов.DocumentDate,
	|	ВТ_ТЗСтрокиДокументов.DocumentNumber,
	|	ВТ_ТЗСтрокиДокументов.LineNumber,
	|	ВТ_ТЗСтрокиДокументов.WareId,
	|	ВТ_ТЗСтрокиДокументов.UnitId,
	|	ВТ_ТЗСтрокиДокументов.Price,
	|	ВТ_ТЗСтрокиДокументов.UnitFactor,
	|	ВТ_ТЗСтрокиДокументов.Quantity,
	|	ВТ_ТЗСтрокиДокументов.QuantityL,
	|	ВТ_ТЗСтрокиДокументов.ProductKind,
	|	ВТ_ТЗСтрокиДокументов.Alcohol,
	|	ВТ_СоответствияНоменклатуры.ТипМонолита,
	|	ВТ_СоответствияНоменклатуры.Номенклатура,
	|	ВТ_СоответствияНоменклатуры.Упаковка,
	|	ВТ_СоответствияНоменклатуры.УпаковкаМонолит,
	...
	Запрос.УстановитьПараметр("ТЗДокументов", 			ТЗДокументов);
	Запрос.УстановитьПараметр("ТЗСтрокиДокументов", 	ТЗСтрокиДокументов);
	Запрос.УстановитьПараметр("ТЗСтрокиПартий",			ТЗСтрокиПартий);
